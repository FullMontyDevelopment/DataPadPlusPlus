...
export function buildSqliteOperationManifests(
  ...
  return [
    ...
    sqliteOperation(connection, 'sqlite.database.backup', 'Backup Database', 'database', 'costly', true, ['diff', 'metrics', 'raw'], 'Plan a guarded SQLite online backup API workflow.'),
    sqliteOperation(connection, 'sqlite.database.restore', 'Restore Database', 'database', 'destructive', true, ['diff', 'metrics', 'raw'], 'Plan restoring a complete SQLite backup into a new database file.'),
