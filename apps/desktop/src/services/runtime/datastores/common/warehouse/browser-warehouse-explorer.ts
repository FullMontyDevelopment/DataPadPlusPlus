...
export function warehouseInspectPayload(
  connection: ConnectionProfile,
  nodeId: string,
  extraPayload: JsonRecord = {},
) {
  const base = warehouseBasePayload(connection, extraPayload)
...
function warehouseBasePayload(connection: ConnectionProfile, extraPayload: JsonRecord) {
  return {
