...
import { buildCockroachOperationManifests } from './datastores/cockroachdb/browser-cockroach-operation-manifests'
import { buildDocumentOperationManifests } from './browser-document-operation-manifests'
import { buildDuckDbOperationManifests } from './datastores/duckdb/browser-duckdb-operation-manifests'
import { buildMemcachedOperationManifests } from './datastores/memcached/browser-memcached-operation-manifests'
import { buildMysqlOperationManifests } from './datastores/common/sql/browser-mysql-operation-manifests'
import { buildPostgresOperationManifests } from './datastores/common/sql/browser-postgres-operation-manifests'
import { buildSearchOperationManifests } from './datastores/common/search/browser-search-operation-manifests'
import { buildSqlServerOperationManifests } from './datastores/sqlserver/browser-sqlserver-operation-manifests'
import { buildSqliteOperationManifests } from './datastores/sqlite/browser-sqlite-operation-manifests'
import { buildTimescaleOperationManifests } from './datastores/timescaledb/browser-timescale-operation-manifests'
import { buildWaveFiveOperationManifests } from './browser-wave5-operation-manifests'
import { buildWideColumnOperationManifests } from './datastores/common/widecolumn/browser-widecolumn-operation-manifests'
