...
const DATA_SPECS: Record<DatastoreEngine, CapabilitySpec> = {
  ...
  clickhouse: plannedData('ClickHouse streams native SELECT FORMAT and INSERT FORMAT payloads.', [portableCsv, ['tsv', 'TSV', 'native', ['tsv'], 'ClickHouse tab-separated data.'], ['json-each-row', 'JSONEachRow', 'native', ['jsonl'], 'ClickHouse JSONEachRow data.'], ['parquet', 'Parquet', 'native', ['parquet'], 'ClickHouse Parquet data.']]),
