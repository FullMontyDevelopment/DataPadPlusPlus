...
const DESCRIPTORS: Record<string, MemcachedObjectViewDescriptor> = {
  ...
  'known-key': descriptor('known-key', 'Open Key Lookup', 'Memcached Known Key', 'Inspect and plan guarded operations for application-known Memcached keys.', 'No key workflow is loaded', 'Refresh the known-key workflow for this server.'),
