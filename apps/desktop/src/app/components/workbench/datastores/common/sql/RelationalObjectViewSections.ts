...
export function sectionCandidates(kind: string) {
  const common = [
    ...
    section('hypertables', 'Hypertables', ['schema', 'name', 'owner', 'timeColumn', 'dimensions', 'chunks', 'compressed', 'retention', 'size', 'chunkTargetSize'], 'No hypertables were returned.'),
    section('chunks', 'Chunks', ['hypertable', 'chunk', 'range', 'rangeStart', 'rangeEnd', 'compressed', 'compressionStatus', 'rows', 'size', 'indexSize'], 'No chunks were returned.'),
    section('compressionPolicies', 'Compression Policies', ['hypertable', 'enabled', 'field', 'segmentBy', 'orderBy', 'policy', 'algorithm'], 'No compression policies were returned.', 'job'),
    section('retentionPolicies', 'Retention Policies', ['hypertable', 'window', 'jobStatus', 'lastRun', 'nextRun', 'failures'], 'No retention policies were returned.', 'job'),
    section('continuousAggregates', 'Continuous Aggregates', ['schema', 'name', 'source', 'bucket', 'materializationHypertable', 'materializedOnly', 'lastRefresh', 'lag', 'invalidationLag'], 'No continuous aggregates were returned.'),
    ...
    section('jobs', 'Jobs', ['name', 'id', 'type', 'jobType', 'object', 'status', 'enabled', 'scheduled', 'lastRun', 'lastStatus', 'nextRun', 'nextStart', 'lastRunDuration', 'totalFailures'], 'No jobs were returned.', 'job'),
