...
const DESCRIPTORS: Record<string, WarehouseObjectViewDescriptor> = {
  ...
  view: descriptor('view', 'Open Warehouse View', 'Warehouse View', 'Inspect view definition metadata, dependencies, columns, grants, and safe query entry points.', 'View metadata is not loaded', 'Refresh this view or check metadata permissions.', 'Query View'),
