...
const DESCRIPTORS: Record<string, CockroachObjectViewDescriptor> = {
  ...
  view: descriptor('view', 'Open View Definition', 'CockroachDB View', 'Inspect definition, columns, dependencies, grants, and a bounded query action.', 'No view definition is loaded', 'Refresh this view to collect definition metadata.', 'Open View Query'),
  ...
  certificates: descriptor('certificates', 'Review Certificates', 'CockroachDB Certificates', 'Review certificate metadata where the connected role can inspect it.', 'No certificates were returned', 'Certificate metadata may be restricted or unavailable on this deployment.'),
  ...
  job: descriptor('job', 'Open Job', 'CockroachDB Job', 'Inspect job progress, status, timestamps, details, and failure messages where available.', 'No job metadata is loaded', 'Refresh this job to collect job metadata.'),
