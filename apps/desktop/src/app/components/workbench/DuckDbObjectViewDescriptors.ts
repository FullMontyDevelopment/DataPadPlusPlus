...
const DESCRIPTORS: Record<string, DuckDbObjectViewDescriptor> = {
  ...
  view: descriptor('view', 'Open View', 'DuckDB View', 'Inspect view columns, dependencies, definition summary, and a bounded query.', 'View metadata is not loaded', 'Refresh this view to collect catalog metadata.', 'Open View Query'),
