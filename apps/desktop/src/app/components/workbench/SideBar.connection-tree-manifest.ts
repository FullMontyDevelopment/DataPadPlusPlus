...
import {
  isRedisLikeConnection,
  redisDatabaseIndexFromPath,
  redisManifestNodeId,
  redisManifestNodeScope,
} from './SideBar.connection-tree-manifest-redis'
import { searchManifestNodeId } from './SideBar.connection-tree-manifest-search'
import {
  sqlManifestNodeId,
