...
const DESCRIPTORS: Record<string, PostgresObjectViewDescriptor> = {
  ...
  view: descriptor('view', 'Open View Definition', 'PostgreSQL View', 'Inspect the view definition, columns, dependencies, grants, and sample-query action.', 'No view definition is loaded', 'Refresh this view to collect definition metadata.', 'Open View Query'),
  ...
  'materialized-view': descriptor('materialized-view', 'Open Materialized View', 'Materialized View', 'Inspect definition, refresh status, indexes, storage, grants, and sample-query action.', 'No materialized view metadata is loaded', 'Refresh this materialized view to collect metadata.', 'Open Data Query'),
