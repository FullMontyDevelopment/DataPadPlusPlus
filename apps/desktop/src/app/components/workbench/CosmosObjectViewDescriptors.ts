...
const DESCRIPTORS: Record<string, CosmosObjectViewDescriptor> = {
  ...
  'stored-procedure': descriptor('stored-procedure', 'Open Stored Procedure', 'Stored Procedure', 'Inspect one stored procedure and its guarded replace/delete workflow.', 'Stored procedure metadata is not loaded', 'Refresh stored procedures or check that this script still exists.'),
  ...
  trigger: descriptor('trigger', 'Open Trigger', 'Trigger', 'Inspect one trigger and its guarded replace/delete workflow.', 'Trigger metadata is not loaded', 'Refresh triggers or check that this trigger still exists.'),
  ...
  udf: descriptor('udf', 'Open UDF', 'User Defined Function', 'Inspect one user-defined function and its guarded replace/delete workflow.', 'User-defined function metadata is not loaded', 'Refresh UDFs or check that this UDF still exists.'),
  ...
  conflict: descriptor('conflict', 'Open Conflict', 'Conflict', 'Inspect one multi-region conflict and the available resolution context.', 'Conflict metadata is not loaded', 'Refresh conflicts or check whether it was already resolved.'),
