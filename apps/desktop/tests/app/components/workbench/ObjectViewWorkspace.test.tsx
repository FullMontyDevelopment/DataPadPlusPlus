...
import { ObjectViewWorkspace } from '../../../../src/app/components/workbench/ObjectViewWorkspace'
...
describe('ObjectViewWorkspace', () => {
  ...
  it('renders PostgreSQL table metadata as a purpose-built catalog workspace', () => {
    ...
    expect(screen.getAllByText('accounts_pkey').length).toBeGreaterThan(0)
    expect(screen.queryByText('Raw inspection payload')).not.toBeInTheDocument()
  ...
  it('renders PostgreSQL diagnostics with pg-native workload sections', () => {
    ...
    expect(screen.getAllByText('orders_updated_at_idx').length).toBeGreaterThan(0)
  ...
  it('renders SQLite maintenance as a native health workflow', () => {
    ...
    expect(screen.getAllByText('quick_check').length).toBeGreaterThan(0)
  ...
  it('renders MySQL diagnostics without raw status command output', () => {
    ...
    expect(screen.getAllByText('SELECT * FROM accounts WHERE status = ?').length).toBeGreaterThan(0)
  ...
  it('renders SQL Server Query Store and security surfaces without generic inspection text', () => {
    ...
    expect(screen.getAllByText('Top Queries').length).toBeGreaterThan(0)
  ...
  it('renders CockroachDB cluster diagnostics as a native cluster workspace', () => {
    ...
    expect(screen.getAllByText('n1.local:26257').length).toBeGreaterThan(0)
